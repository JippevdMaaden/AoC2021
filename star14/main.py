...
def count_pyramid_steps(number):
    # TODO: This takes quite a long time for bigger numbers, find a better way
    steps = 0
...
def align_crabs(crab_dict, min_value, max_value):
    ...
    for i in range(min_value, max_value + 1):
        ...
        for crab_distance, crab_count in crab_dict.items():
            travel_distance = count_pyramid_steps(abs(crab_distance - i))
